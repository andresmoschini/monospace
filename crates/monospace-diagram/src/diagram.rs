...
/// A shape's identity: normally generated by the diagram that placed it and unique within it
/// (FR-001, FR-002), though [`ShapeId::new`] can also build one directly from its text.
